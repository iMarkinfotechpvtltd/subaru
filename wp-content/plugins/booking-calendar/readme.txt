...
You need to select the "Enable Hours" option from Theme settings page(from General tabe).
Then add default hours or add single hour as you need. After that configure the other options and select the Hours theme for the Calendar you need.
